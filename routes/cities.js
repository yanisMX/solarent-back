...
router.get("/", async (req, res) => {
  try {
    ...
    res
      .status(500)
      .send("Une erreur est survenue lors de la récupération des villes.");
  }
});

// GET a single city by code_name
router.get("/:code_name", async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .send("Une erreur est survenue lors de la récupération de la ville.");
  }
});
